...
import pandas as pd
from easyai.forms import NormalTargetSettingForm
from easyai.views.base import TargetSettingView

class NormalTargetSettingView(TargetSettingView):
    template_name = 'easyai/full/target_setting.html'
    form_class = NormalTargetSettingForm
    success_url = reverse_lazy('easyai:normal_delete_string')
