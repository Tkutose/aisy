...
class FullTargetSettingView(TargetSettingView):
    template_name = 'easyai/full/target_setting.html'
    form_class = EasyTargetSettingForm
    success_url = reverse_lazy('easyai:full_delete_string')
    ...
    def make_ml_instance(self, model_type, objective, path, task):
        ...
        オーバーライド
        """
        self.ml_controller.nn_ensemble_init(self.user_id, model_type, objective, path, task)